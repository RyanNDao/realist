...
TRULIA_DETAILED_QUERY_VARIABLES_EXAMPLE = {
  "query": """
    query WEB_homeDetailsClientTopThirdLookUp($url1: String!, $url2: String!, $url3: String!) {

        homeDetailsByUrl1: homeDetailsByUrl(url: $url1) {
            url
        ...
        homeDetailsByUrl2: homeDetailsByUrl(url: $url2) {
            url
            ...HomeDetailsDescriptionFragment
            ...HomeDetailsListingProviderFragment
            ...HomeDetailsFeaturesFragment
        ...
        homeDetailsByUrl3: homeDetailsByUrl(url: $url3) {
            url
            ...HomeDetailsDescriptionFragment
            ...HomeDetailsListingProviderFragment
            ...HomeDetailsFeaturesFragment
...
""",
  "variables": {
    "url1": "/home/230-montrose-st-philadelphia-pa-19147-10177108",
    "url2": "/home/200-head-house-ct-philadelphia-pa-19147-10182414",
    "url3": "/home/230-montrose-st-philadelphia-pa-19147-10177108"
  }
}