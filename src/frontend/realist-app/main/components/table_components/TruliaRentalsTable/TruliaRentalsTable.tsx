...
interface TruliaRentalsTableProps {
    isFetching: boolean
    listings?: ApiTruliaListingResponse[];

}

export function TruliaRentalsTable ({isFetching, listings}: TruliaRentalsTableProps){
    console.log('truliarentals table loading', listings)
    ...
    return (
        <Flex width="100%" height="100%" minHeight="150px" className="ag-theme-quartz">
            {   
